...
CREATE TABLE `film` (
  ...
  KEY `fk_film_nazione` (`id_nazione`),
  CONSTRAINT `fk_film_genere` FOREIGN KEY (`id_genere`) REFERENCES `genere` (`id`),
  CONSTRAINT `fk_film_nazione` FOREIGN KEY (`id_nazione`) REFERENCES `nazione` (`id`)
...
INSERT INTO `nazione` VALUES (4,'Germania'),(3,'Italia'),(2,'UK'),(1,'USA');
...
-- Dump completed on 2025-03-28 12:15:08
