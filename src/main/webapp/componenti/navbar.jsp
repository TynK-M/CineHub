        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"> Film </a>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="nav-item d-flex gap-2">
                            <a class="btn btn-outline-success" href="autenticazione/login.jsp">Accedi</a>
